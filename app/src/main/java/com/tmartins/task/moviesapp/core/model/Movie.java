...
public class Movie {
    ...
    public Movie(long voteCount, long id, Boolean video, Float voteAverage, String title,
                 ...
                 String releaseDate, Collection collection, Integer budget, List<Genre> genres,
                 String homepage, long id1, String imdbId, List<Company> companies,
                 List<ProductionCountry> productionCountries, Integer revenue, Integer runtime,
                 List<Language> languages, String status, String tagline) {
